...
function DocxHighlightView({
  ...
  return (
    <div className="max-w-[800px] mx-auto py-8 px-6">
      <div className="bg-card shadow-lg rounded-lg p-8 space-y-0 [&_img]:max-w-full [&_img]:h-auto [&_img]:!static [&_img]:inline-block [&_img]:!transform-none [&_img]:!m-0" style={{ minHeight: '80vh' }}>
        {paragraphs.map((p, i) => {
