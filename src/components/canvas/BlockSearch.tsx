...
export default function BlockSearch({ blocks, onNavigateTo }: BlockSearchProps) {
  ...
  if (!open) {
    return (
      <button
        ...
        className="absolute top-4 right-4 z-50 h-9 w-9 flex items-center justify-center rounded-lg bg-toolbar border border-toolbar-border shadow-lg hover:bg-accent transition-colors"
  ...
  return (
    <div className="absolute top-4 right-4 z-50 w-72 bg-popover border border-border rounded-lg shadow-xl overflow-hidden">
